...
public class A_G {
	...
	int[][] Individuo = new int[1000][10]; // Populacao = 1000// int Populacao = 1000;
	// int Geracoes = 1000;
	// int Mutacao = 10;
	// int Cromossomo = 10;
	...
	public void Avaliar() {
		...
		for (a = 0; a < 1000; a++) { // Populacao = 1000
			for (b = 0; b < 10; b++) {
	...
	public void Solucao() {
		...
		for (a = 1000 - 1; a >= 1; a--) { // Populacao = 1000
			for (b = 1; b < a; b++) {
	...
	public int Sorteio() {
		...
		;
		for (a = 0; a < 1000 - 1; a++) { // Populacao = 1000
	...
	public void _MT_(int index) {
		...
		do {
			numero_A = Math.random() * 10;
			numero_B = Math.round(numero_A);
			numero_C = (int) numero_B;
		} while (numero_C > 9);

		y = Valores_Aleatorios.nextInt(Relase + 1);
	...
	public void Cruzamento_X() {
		...
		for (a = 0; a < 1000; a += 2) { // Populacao = 1000
			z = c.nextInt(100);
			if (z <= Cruzamento) {
	...
	public void constroi() {
		int a, b;
		for (a = 0; a < 1000; a++) { // Populacao = 1000
			for (b = 0; b < 10; b++) { // Cromossomo = 10
				Individuo[a][b] = Valores_Aleatorios.nextInt(Relase + 1);
			}
		}
	}
	...
	public void info() {
		...
		int a;
		for (a = 0; a < 1000; a++) { // Populacao = 1000
			System.out.println(a+ " - Media dos Individuos: " + this.Media());
			System.out.println("Melhor Individuo Gerado: " + Valor_Ftness[0][0]);
			this.Cruzamento_X();
		}
		...
		for (a = 0; a < 10; a++) {
			System.out.print("|" + Individuo[0][a]);
		}
	}
